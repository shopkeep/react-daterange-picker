...
var CalendarMonth = (0, _createReactClass2.default)({
  ...
  renderDay: function renderDay(date, i) {
    var _props = this.props,
        ...
        weekBandingDateRange = _props.weekBandingDateRange,
        props = _objectWithoutProperties(_props, ['dateComponent', 'value', 'highlightedDate', 'highlightedRange', 'hideSelection', 'enabledRange', 'weekBandingDateRange']);
    ...
    return _react2.default.createElement(CalendarDate, _extends({
      ...
      isHighlightedDate: !!(highlightedDate && (highlightedDate.isSame(d, 'day') || weekBandingDateRange && _WeekBand2.default.checkInWeekBand(highlightedDate, d))),
